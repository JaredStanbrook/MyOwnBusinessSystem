...
function indexArray(value, array) {
    for (x in array) {
        if (array[x][0] == value) {
            return x;
        }
...
async function postReq(params = {}) {
    if (_utils__WEBPACK_IMPORTED_MODULE_0__.isNull(params.data) || !_utils__WEBPACK_IMPORTED_MODULE_0__.isString(params.key)) {
        console.log("Type Error");
        return 0;
    }
    try {
...
async function deleteReq(params = {}) {
    if (!_utils__WEBPACK_IMPORTED_MODULE_0__.isString(params.key)) {
        console.log("Type Error");
        return 0;
    }
    try {
